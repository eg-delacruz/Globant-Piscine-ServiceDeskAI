// Types
import type { Report, ReportStatus } from '@/state/report/reportSlice';
        ...
        <form onSubmit={handleSave} className='space-y-6'>
          ...
          <div>
            ...
            <div className='relative'>
              {incommingStatus === 'closed' ? (
                <div className='w-full px-4 py-3 rounded-xl border-2 appearance-none font-semibold focus:outline-none transition-all cursor-pointer bg-slate-100 border-slate-200 text-slate-700 focus:ring-slate-500'>
                  Closed
                </div>
              ) : (
                <>
          ...
          {incommingStatus === 'closed' ? (
            <div className='animate-fade-in-up'>
              ...
              <div className='w-full px-4 py-3 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all shadow-inner resize-none'>
          ...
          {/* Action Buttons */}
          <button
            disabled={incommingStatus === 'closed'}
            type='submit'
          ...
          >
            ...
            {modifyReportStatus === 'loading' ? 'Saving...' : 'Save Changes'}
          </button>
        </form>
      </div>
    </div>
