...
// TODO: validate empty fields, email format, etc.
// TODO: separate this component into smaller components to be used later in the app
const DeskaiLogin = () => {
  ...
  return (
    // Outer container: New Cool-toned gradient background (Slate -> Blue -> Teal)
      ...
      <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden z-10 border border-white/20">
        ...
        <div className="p-8 sm:p-10">
          ...
          <div className="text-center mb-10">
            {/* The "deskai" typography logo with new cool gradient */}
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-4 px-6 bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600 text-white text-lg font-bold rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 ease-out focus:ring-4 focus:ring-blue-300/50"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-600">
              Need access?{' '}
              <a href="#" className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-600 hover:opacity-80 transition-opacity">
                Contact IT Support
              </a>
            </p>
          </div>
